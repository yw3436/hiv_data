...
``` r
data12 = read_excel('./hiv_data/2012.xlsx', range = 'A8:AG48', col_names = FALSE) %>%
  janitor::clean_names() %>%
...
``` r
data12_d = read_excel('./hiv_data/2012.xlsx', range = 'A49:AH324', col_names = FALSE) %>%
  janitor::clean_names() %>%
...
``` r
data13 = read_excel('./hiv_data/2013.xlsx', range = 'A8:AG48', col_names = FALSE) %>%
  janitor::clean_names() %>% 
...
``` r
data13_d = read_excel('./hiv_data/2013.xlsx', range = 'A49:AG324', col_names = FALSE) %>%
  janitor::clean_names() %>% 
...
``` r
data14 = read_excel('./hiv_data/2014.xlsx', range = 'A8:AG48', col_names = FALSE) %>%
  janitor::clean_names() %>% 
...
``` r
data14_d = read_excel('./hiv_data/2014.xlsx', range = 'A50:AD335', col_names = FALSE) %>%
  janitor::clean_names() %>%
...
``` r
data15 = read_excel('./hiv_data/2015.xlsx', range = 'A8:AG49', col_names = FALSE) %>%
  janitor::clean_names() %>% 
...
``` r
data15_d = read_excel('./hiv_data/2015.xlsx', range = 'A50:AG335', col_names = FALSE) %>%
  janitor::clean_names() %>%
...
``` r
data16 = read_excel('./hiv_data/2016.xlsx', range = 'A8:AC49', col_names = FALSE) %>%
  janitor::clean_names() %>%
...
``` r
data16_d = read_excel('./hiv_data/2016.xlsx', range = 'A50:AC335', col_names = FALSE) %>%
  janitor::clean_names() %>%
...
``` r
data17 = read_excel('./hiv_data/2017.xlsx', range = 'A8:AD49', col_names = FALSE) %>%
  janitor::clean_names() %>%
  select(x1, x5, x8, x10, x11, x13, x15, x16, x21, x25, x29, x30) %>%
  filter(!is.na(x5)) %>% 
  filter(!str_detect(x1, "poverty")) %>% 
...
``` r
data17_d = read_excel('./hiv_data/2017.xlsx', range = 'A50:AD335', col_names = FALSE) %>%
  janitor::clean_names() %>% 
  select(x1, x6, x8, x10, x11, x13, x15, x16, x22, x25, x29, x30) %>%
  filter(!is.na(x6)) %>% 
  filter(!str_detect(x1, "poverty")) %>% 
...
``` r
data18 = read_excel('./hiv_data/2018.xlsx', range = 'A7:BU128', col_names = FALSE) %>%
  janitor::clean_names() %>% 
...
``` r
data19 = read_excel('./hiv_data/2019.xlsx', range = 'A7:O128', col_names = FALSE) %>%
  janitor::clean_names() %>%
...
write.csv(hiv_complete,'data_complete.csv')
```
